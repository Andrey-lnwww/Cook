...
/* harmony import */ var _components_exitModalMap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/exitModalMap */ "./src/js/components/exitModalMap.js");
/* harmony import */ var _components_exitModalMap__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_exitModalMap__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _components_parallax__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/parallax */ "./src/js/components/parallax.js");
/* harmony import */ var _components_parallax__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_parallax__WEBPACK_IMPORTED_MODULE_3__);
...
if (document.documentElement.scrollHeight >= 884) {}
...
/***/ "./src/js/components/exitModalMap.js":
/*!*******************************************!*\
  !*** ./src/js/components/exitModalMap.js ***!
  \*******************************************/
/***/ (() => {

const closeBtn = document.querySelector('.map-info__close');
const mapPopup = document.querySelector('.map-info');
const map = document.querySelector('.map');
function createBtn() {
  const openMenu = document.createElement('button');
  openMenu.classList.add('map-info--open');
  const openMenuArrow = document.createElement('span');
  openMenuArrow.classList.add('map-info--open-arrow');
  openMenu.append(openMenuArrow);
  openMenu.classList.add('btn-reset');
  map.append(openMenu);
  openMenu.addEventListener("click", e => {
    const target = e.target;
    if (target.classList.contains('map-info--open') || target.parentNode.classList.contains('map-info--open')) {
      openMenu.remove();
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const menuSearch = document.querySelector('.services__search');
  const searchWrapper = document.querySelector('.search');
  menuSearch.addEventListener("click", e => {
    if (!menuSearch.classList.contains('search--active')) {
      searchWrapper.classList.add('search--active', 'fade-fast');
    }
  });
  window.addEventListener('click', e => {
    const target = e.target;
    if (!target.closest('.services__search') && !target.closest('.search')) {
      searchWrapper.classList.remove('search--active', 'fade-fast');
    }
  });
});
...
const tabsBtns = document.querySelectorAll('.tabs__title');
const tabContent = document.querySelectorAll('.checkout__list');
const activeTab = document.querySelector('.tabs__title--active');
function hideTabs() {
  tabContent.forEach(item => {
    item.classList.add('hideFade');
    item.classList.remove('showFade', 'fade');
  });
...
function showTabs() {
  ...
  tabContent[i].classList.add('showFade', 'fade');
  tabContent[i].classList.remove('hideFade');
  tabsBtns[i].classList.add('tabs__title--active');
}
hideTabs();
showTabs();
tabsBtns.forEach(tab => {
